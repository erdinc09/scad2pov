...
openscad_vpr = $vpr;
openscad_vpt = $vpt;
openscad_vpd = $vpd; //500; // openscad issue #839;
openscad_vpw = 800;
openscad_vph = 450;
...
//openscad_vpt, openscad_vpr, openscad_vpd, openscad_vpw, openscad_vph
module printCameraAndLightSourceParameters()
{
    echo(str("openscad_vpr = ", printPovVector(openscad_vpr)));
    echo(str("openscad_vpt = ", printPovVector(openscad_vpt)));
    echo(str("openscad_vpd = ", openscad_vpd));
    echo(str("openscad_vpw = ", 800, " custom value, as an example, can be changed manually !"));
    echo(str("openscad_vph = ", 450, " custom value, as an example, can be changed manually !"));
    echo(str("scad_camera(",printPovVector(openscad_vpt),",",printPovVector(openscad_vpr),",",openscad_vpd,",", 800,",", 450,")"));
    echo(str("scad_light_source(",printPovVector(openscad_vpt),",",printPovVector(openscad_vpr),",",openscad_vpd,")"));
}

function printPovVector(v) = str("&#60;", v[0], ",", v[1], ",", v[2], "&#62;");